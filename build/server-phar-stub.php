...
function preparePharCacheDirectory() : string{
	...
	$i = 0;
	do{
		$tmpPath = sys_get_temp_dir() . '/TeamCraft-MP-phar-cache.' . $i;
		$i++;
...
/**
 * Prepares a decompressed .tar of TeamCraft-MP.phar in the system temp directory for loading code from.
 *
...
echo "Preparing TeamCraft-MP.phar decompressed cache...\n";
$start = hrtime(true);
